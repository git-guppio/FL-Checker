...
class ProcessManager {
    ...
    static SetupEventListeners() {
        EventManager.Subscribe("ProcessStarted", (data) => ProcessManager.UpdateProcessStatus(data.processId, data.status, data.details))
        EventManager.Subscribe("ProcessProgress", (data) => ProcessManager.UpdateProcessStatus(data.processId, data.status, data.details))
        EventManager.Subscribe("ProcessCompleted", (data) => ProcessManager.UpdateProcessStatus(data.processId, data.status, data.details))
        EventManager.Subscribe("ProcessError", (data) => ProcessManager.UpdateProcessStatus(data.processId, data.status, data.details))
    }

    static UpdateProcessStatus(processId, status, details := "") {
